 ...
 * counter terrorist have same mission. But weapon here is extrinsic, because
 * they may chose different weapons.
 */
public class CounterTerrorists implements Player {
    ...
    @Override
    public void mission() {
        System.out.println("Counter Terrorist with weapon " + this.weapon);
